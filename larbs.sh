...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://gitlab.com/Stefanski1899/voidrice.git" && repobranch="chambln-refactor"
...
dialog --title "LARBS Installation" --infobox "Finally, installing \`libxft\` to enable color emoji in suckless software without crashes." 5 70
yes | sudo -u "$name" $aurhelper -S libxft >/dev/null 2>&1
